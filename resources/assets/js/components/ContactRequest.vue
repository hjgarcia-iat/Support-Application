<template>
    <div class="p-8">
        ...
        <div v-show="step === 1">
            <div class="mb-6">
                ...
                <div class="flex items-center">
                    <input type="radio" name="reason"
                        id="reason_1" value="Curriculum" v-model="reason"> <label
                    class="ml-2 text-grey-darker text-sm mb-2" for="reason_1"><strong>Curriculum Question</strong>
                    &mdash;
                    Questions about how our curriculum is to be used in the classroom. Can't find curriculum resources.</label>
                </div>
                <div class="flex items-center">
                    <input type="radio" name="reason"
                        id="reason_2" value="Feedback" v-model="reason"> <label
                    class="ml-2 text-grey-darker text-sm mb-2" for="reason_2"><strong>Feedback/Feature Request</strong>
                    &mdash;
                ...
                <div class="flex items-center">
                    <input type="radio" name="reason"
                        id="reason_3" value="Tech Issue" v-model="reason"> <label
                    class="ml-2 text-grey-darker text-sm mb-2" for="reason_3"><strong>Technical Problem</strong> &mdash;
                    Something is not working as it should. I this category too broad?</label>
                </div>

                <div class="flex items-center">
                    <input type="radio" name="reason"
                        id="reason_4" value="Login Issue" v-model="reason"> <label
                    class="ml-2 text-grey-darker text-sm mb-2" for="reason_4"><strong>Login Issue</strong> &mdash;
            ...
            <button @click.prevent="next()" type="submit" :disabled="!disabled()"
        ...
        <div v-show="step === 2">
            <form method="POST"
                ...
                <a @click.prevent="prev()" type="submit" v-if="isInvalid()"
