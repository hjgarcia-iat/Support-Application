                    ...
                    <form method="POST"
                        ...
                        <div class="mt-4 md:grid grid-cols-6 gap-8 items-center">
                            ...
                            <x-select id="name"
                                ...
                                <option value="High"
                                        @if (old('type') === "High") selected="selected" @endif>High
                                </option>
                                <option value="Medium"
                                        @if (old('type') === "Medium") selected="selected" @endif>Medium
                                </option>
                                <option value="Low"
                                        @if (old('type') === "Low") selected="selected" @endif>Low
                                </option>
                                <option value="Default"
                                        @if (old('type') === "Default") selected="selected" @endif>Default
                                </option>
                            </x-select>
                        </div>
                        ...
                        <div class="mt-4 md:grid grid-cols-6 gap-8">
                            ...
                            <div class="col-span-5">
                                <x-textarea id="post"
                                            ...
                                            type="text"
                                            name="post"
                                            :value="old('post')">{{ old('post') }}</x-textarea>
                            </div>
                        </div>
